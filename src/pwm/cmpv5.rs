#[doc = "Reader of register CMPV5"]
pub type R = crate::R<u32, super::CMPV5>;
#[doc = "Writer for register CMPV5"]
pub type W = crate::W<u32, super::CMPV5>;
#[doc = "Register CMPV5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMPV5 {
    #[inline(always)]
