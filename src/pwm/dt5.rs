#[doc = "Reader of register DT5"]
pub type R = crate::R<u32, super::DT5>;
#[doc = "Writer for register DT5"]
pub type W = crate::W<u32, super::DT5>;
#[doc = "Register DT5 `reset()`'s with value 0"]
impl crate::ResetValue for super::DT5 {
    #[inline(always)]
