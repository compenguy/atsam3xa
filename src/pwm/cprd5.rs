#[doc = "Reader of register CPRD5"]
pub type R = crate::R<u32, super::CPRD5>;
#[doc = "Writer for register CPRD5"]
pub type W = crate::W<u32, super::CPRD5>;
#[doc = "Register CPRD5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CPRD5 {
    #[inline(always)]
