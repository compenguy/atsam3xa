#[doc = "Reader of register CPRD1"]
pub type R = crate::R<u32, super::CPRD1>;
#[doc = "Writer for register CPRD1"]
pub type W = crate::W<u32, super::CPRD1>;
#[doc = "Register CPRD1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CPRD1 {
    #[inline(always)]
