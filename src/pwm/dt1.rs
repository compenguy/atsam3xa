#[doc = "Reader of register DT1"]
pub type R = crate::R<u32, super::DT1>;
#[doc = "Writer for register DT1"]
pub type W = crate::W<u32, super::DT1>;
#[doc = "Register DT1 `reset()`'s with value 0"]
impl crate::ResetValue for super::DT1 {
    #[inline(always)]
