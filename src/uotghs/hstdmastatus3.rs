#[doc = "Reader of register HSTDMASTATUS3"]
pub type R = crate::R<u32, super::HSTDMASTATUS3>;
#[doc = "Writer for register HSTDMASTATUS3"]
pub type W = crate::W<u32, super::HSTDMASTATUS3>;
#[doc = "Register HSTDMASTATUS3 `reset()`'s with value 0"]
impl crate::ResetValue for super::HSTDMASTATUS3 {
    #[inline(always)]
