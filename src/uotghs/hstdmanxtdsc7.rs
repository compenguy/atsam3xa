#[doc = "Reader of register HSTDMANXTDSC7"]
pub type R = crate::R<u32, super::HSTDMANXTDSC7>;
#[doc = "Writer for register HSTDMANXTDSC7"]
pub type W = crate::W<u32, super::HSTDMANXTDSC7>;
#[doc = "Register HSTDMANXTDSC7 `reset()`'s with value 0"]
impl crate::ResetValue for super::HSTDMANXTDSC7 {
    #[inline(always)]
