#[doc = "Reader of register MDL6"]
pub type R = crate::R<u32, super::MDL6>;
#[doc = "Writer for register MDL6"]
pub type W = crate::W<u32, super::MDL6>;
#[doc = "Register MDL6 `reset()`'s with value 0"]
impl crate::ResetValue for super::MDL6 {
    #[inline(always)]
