#[doc = "Reader of register MDL1"]
pub type R = crate::R<u32, super::MDL1>;
#[doc = "Writer for register MDL1"]
pub type W = crate::W<u32, super::MDL1>;
#[doc = "Register MDL1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MDL1 {
    #[inline(always)]
