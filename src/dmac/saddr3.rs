#[doc = "Reader of register SADDR3"]
pub type R = crate::R<u32, super::SADDR3>;
#[doc = "Writer for register SADDR3"]
pub type W = crate::W<u32, super::SADDR3>;
#[doc = "Register SADDR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::SADDR3 {
    #[inline(always)]
