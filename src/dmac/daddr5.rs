#[doc = "Reader of register DADDR5"]
pub type R = crate::R<u32, super::DADDR5>;
#[doc = "Writer for register DADDR5"]
pub type W = crate::W<u32, super::DADDR5>;
#[doc = "Register DADDR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::DADDR5 {
    #[inline(always)]
