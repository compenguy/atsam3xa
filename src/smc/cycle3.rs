#[doc = "Reader of register CYCLE3"]
pub type R = crate::R<u32, super::CYCLE3>;
#[doc = "Writer for register CYCLE3"]
pub type W = crate::W<u32, super::CYCLE3>;
#[doc = "Register CYCLE3 `reset()`'s with value 0x0003_0003"]
impl crate::ResetValue for super::CYCLE3 {
    #[inline(always)]
