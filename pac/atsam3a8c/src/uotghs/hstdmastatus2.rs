#[doc = "Reader of register HSTDMASTATUS2"]
pub type R = crate::R<u32, super::HSTDMASTATUS2>;
#[doc = "Writer for register HSTDMASTATUS2"]
pub type W = crate::W<u32, super::HSTDMASTATUS2>;
#[doc = "Register HSTDMASTATUS2 `reset()`'s with value 0"]
impl crate::ResetValue for super::HSTDMASTATUS2 {
    #[inline(always)]
