#[doc = "Reader of register CPRD3"]
pub type R = crate::R<u32, super::CPRD3>;
#[doc = "Writer for register CPRD3"]
pub type W = crate::W<u32, super::CPRD3>;
#[doc = "Register CPRD3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CPRD3 {
    #[inline(always)]
