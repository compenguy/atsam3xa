#[doc = "Reader of register CDTY7"]
pub type R = crate::R<u32, super::CDTY7>;
#[doc = "Writer for register CDTY7"]
pub type W = crate::W<u32, super::CDTY7>;
#[doc = "Register CDTY7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDTY7 {
    #[inline(always)]
