#[doc = "Reader of register PULSE7"]
pub type R = crate::R<u32, super::PULSE7>;
#[doc = "Writer for register PULSE7"]
pub type W = crate::W<u32, super::PULSE7>;
#[doc = "Register PULSE7 `reset()`'s with value 0x0101_0101"]
impl crate::ResetValue for super::PULSE7 {
    #[inline(always)]
