#[doc = "Reader of register CYCLE4"]
pub type R = crate::R<u32, super::CYCLE4>;
#[doc = "Writer for register CYCLE4"]
pub type W = crate::W<u32, super::CYCLE4>;
#[doc = "Register CYCLE4 `reset()`'s with value 0x0003_0003"]
impl crate::ResetValue for super::CYCLE4 {
    #[inline(always)]
