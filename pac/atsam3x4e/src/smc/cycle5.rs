#[doc = "Reader of register CYCLE5"]
pub type R = crate::R<u32, super::CYCLE5>;
#[doc = "Writer for register CYCLE5"]
pub type W = crate::W<u32, super::CYCLE5>;
#[doc = "Register CYCLE5 `reset()`'s with value 0x0003_0003"]
impl crate::ResetValue for super::CYCLE5 {
    #[inline(always)]
