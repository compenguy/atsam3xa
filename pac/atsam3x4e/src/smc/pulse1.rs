#[doc = "Reader of register PULSE1"]
pub type R = crate::R<u32, super::PULSE1>;
#[doc = "Writer for register PULSE1"]
pub type W = crate::W<u32, super::PULSE1>;
#[doc = "Register PULSE1 `reset()`'s with value 0x0101_0101"]
impl crate::ResetValue for super::PULSE1 {
    #[inline(always)]
