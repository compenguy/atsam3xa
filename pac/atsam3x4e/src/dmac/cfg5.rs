#[doc = "Reader of register CFG5"]
pub type R = crate::R<u32, super::CFG5>;
#[doc = "Writer for register CFG5"]
pub type W = crate::W<u32, super::CFG5>;
#[doc = "Register CFG5 `reset()`'s with value 0x0100_0000"]
impl crate::ResetValue for super::CFG5 {
    #[inline(always)]
