#[doc = "Reader of register MID3"]
pub type R = crate::R<u32, super::MID3>;
#[doc = "Writer for register MID3"]
pub type W = crate::W<u32, super::MID3>;
#[doc = "Register MID3 `reset()`'s with value 0"]
impl crate::ResetValue for super::MID3 {
    #[inline(always)]
