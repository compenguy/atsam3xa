#[doc = "Reader of register CDTY3"]
pub type R = crate::R<u32, super::CDTY3>;
#[doc = "Writer for register CDTY3"]
pub type W = crate::W<u32, super::CDTY3>;
#[doc = "Register CDTY3 `reset()`'s with value 0"]
impl crate::ResetValue for super::CDTY3 {
    #[inline(always)]
