#[doc = "Reader of register PULSE4"]
pub type R = crate::R<u32, super::PULSE4>;
#[doc = "Writer for register PULSE4"]
pub type W = crate::W<u32, super::PULSE4>;
#[doc = "Register PULSE4 `reset()`'s with value 0x0101_0101"]
impl crate::ResetValue for super::PULSE4 {
    #[inline(always)]
