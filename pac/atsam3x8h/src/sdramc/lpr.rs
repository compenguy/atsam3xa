#[doc = "Reader of register LPR"]
pub type R = crate::R<u32, super::LPR>;
#[doc = "Writer for register LPR"]
pub type W = crate::W<u32, super::LPR>;
#[doc = "Register LPR `reset()`'s with value 0"]
impl crate::ResetValue for super::LPR {
    #[inline(always)]
