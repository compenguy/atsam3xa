#[doc = "Reader of register MID6"]
pub type R = crate::R<u32, super::MID6>;
#[doc = "Writer for register MID6"]
pub type W = crate::W<u32, super::MID6>;
#[doc = "Register MID6 `reset()`'s with value 0"]
impl crate::ResetValue for super::MID6 {
    #[inline(always)]
