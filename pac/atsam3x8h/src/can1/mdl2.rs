#[doc = "Reader of register MDL2"]
pub type R = crate::R<u32, super::MDL2>;
#[doc = "Writer for register MDL2"]
pub type W = crate::W<u32, super::MDL2>;
#[doc = "Register MDL2 `reset()`'s with value 0"]
impl crate::ResetValue for super::MDL2 {
    #[inline(always)]
