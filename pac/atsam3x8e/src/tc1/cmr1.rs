#[doc = "Reader of register CMR1"]
pub type R = crate::R<u32, super::CMR1>;
#[doc = "Writer for register CMR1"]
pub type W = crate::W<u32, super::CMR1>;
#[doc = "Register CMR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMR1 {
    #[inline(always)]
