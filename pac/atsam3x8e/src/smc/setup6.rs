#[doc = "Reader of register SETUP6"]
pub type R = crate::R<u32, super::SETUP6>;
#[doc = "Writer for register SETUP6"]
pub type W = crate::W<u32, super::SETUP6>;
#[doc = "Register SETUP6 `reset()`'s with value 0x0101_0101"]
impl crate::ResetValue for super::SETUP6 {
    #[inline(always)]
