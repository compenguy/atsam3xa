#[doc = "Reader of register SETUP4"]
pub type R = crate::R<u32, super::SETUP4>;
#[doc = "Writer for register SETUP4"]
pub type W = crate::W<u32, super::SETUP4>;
#[doc = "Register SETUP4 `reset()`'s with value 0x0101_0101"]
impl crate::ResetValue for super::SETUP4 {
    #[inline(always)]
