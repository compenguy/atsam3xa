#[doc = "Reader of register MDL3"]
pub type R = crate::R<u32, super::MDL3>;
#[doc = "Writer for register MDL3"]
pub type W = crate::W<u32, super::MDL3>;
#[doc = "Register MDL3 `reset()`'s with value 0"]
impl crate::ResetValue for super::MDL3 {
    #[inline(always)]
