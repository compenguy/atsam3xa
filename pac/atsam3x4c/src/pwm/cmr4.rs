#[doc = "Reader of register CMR4"]
pub type R = crate::R<u32, super::CMR4>;
#[doc = "Writer for register CMR4"]
pub type W = crate::W<u32, super::CMR4>;
#[doc = "Register CMR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMR4 {
    #[inline(always)]
