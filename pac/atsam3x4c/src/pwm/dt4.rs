#[doc = "Reader of register DT4"]
pub type R = crate::R<u32, super::DT4>;
#[doc = "Writer for register DT4"]
pub type W = crate::W<u32, super::DT4>;
#[doc = "Register DT4 `reset()`'s with value 0"]
impl crate::ResetValue for super::DT4 {
    #[inline(always)]
