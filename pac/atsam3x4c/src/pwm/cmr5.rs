#[doc = "Reader of register CMR5"]
pub type R = crate::R<u32, super::CMR5>;
#[doc = "Writer for register CMR5"]
pub type W = crate::W<u32, super::CMR5>;
#[doc = "Register CMR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMR5 {
    #[inline(always)]
