#[doc = "Reader of register CPRD7"]
pub type R = crate::R<u32, super::CPRD7>;
#[doc = "Writer for register CPRD7"]
pub type W = crate::W<u32, super::CPRD7>;
#[doc = "Register CPRD7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CPRD7 {
    #[inline(always)]
