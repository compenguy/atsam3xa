#[doc = "Reader of register CMR7"]
pub type R = crate::R<u32, super::CMR7>;
#[doc = "Writer for register CMR7"]
pub type W = crate::W<u32, super::CMR7>;
#[doc = "Register CMR7 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMR7 {
    #[inline(always)]
