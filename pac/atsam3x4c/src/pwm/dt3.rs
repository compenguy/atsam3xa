#[doc = "Reader of register DT3"]
pub type R = crate::R<u32, super::DT3>;
#[doc = "Writer for register DT3"]
pub type W = crate::W<u32, super::DT3>;
#[doc = "Register DT3 `reset()`'s with value 0"]
impl crate::ResetValue for super::DT3 {
    #[inline(always)]
