#[doc = "Reader of register MAM7"]
pub type R = crate::R<u32, super::MAM7>;
#[doc = "Writer for register MAM7"]
pub type W = crate::W<u32, super::MAM7>;
#[doc = "Register MAM7 `reset()`'s with value 0"]
impl crate::ResetValue for super::MAM7 {
    #[inline(always)]
