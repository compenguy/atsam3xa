#[doc = "Reader of register MID0"]
pub type R = crate::R<u32, super::MID0>;
#[doc = "Writer for register MID0"]
pub type W = crate::W<u32, super::MID0>;
#[doc = "Register MID0 `reset()`'s with value 0"]
impl crate::ResetValue for super::MID0 {
    #[inline(always)]
