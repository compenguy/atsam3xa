#[doc = "Reader of register MID7"]
pub type R = crate::R<u32, super::MID7>;
#[doc = "Writer for register MID7"]
pub type W = crate::W<u32, super::MID7>;
#[doc = "Register MID7 `reset()`'s with value 0"]
impl crate::ResetValue for super::MID7 {
    #[inline(always)]
