#[doc = "Reader of register MID2"]
pub type R = crate::R<u32, super::MID2>;
#[doc = "Writer for register MID2"]
pub type W = crate::W<u32, super::MID2>;
#[doc = "Register MID2 `reset()`'s with value 0"]
impl crate::ResetValue for super::MID2 {
    #[inline(always)]
