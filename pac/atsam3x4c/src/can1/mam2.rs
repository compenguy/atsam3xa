#[doc = "Reader of register MAM2"]
pub type R = crate::R<u32, super::MAM2>;
#[doc = "Writer for register MAM2"]
pub type W = crate::W<u32, super::MAM2>;
#[doc = "Register MAM2 `reset()`'s with value 0"]
impl crate::ResetValue for super::MAM2 {
    #[inline(always)]
