#[doc = "Reader of register MATRIX_WPMR"]
pub type R = crate::R<u32, super::MATRIX_WPMR>;
#[doc = "Writer for register MATRIX_WPMR"]
pub type W = crate::W<u32, super::MATRIX_WPMR>;
#[doc = "Register MATRIX_WPMR `reset()`'s with value 0"]
impl crate::ResetValue for super::MATRIX_WPMR {
    #[inline(always)]
