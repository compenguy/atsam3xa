#[doc = "Reader of register HSTDMANXTDSC2"]
pub type R = crate::R<u32, super::HSTDMANXTDSC2>;
#[doc = "Writer for register HSTDMANXTDSC2"]
pub type W = crate::W<u32, super::HSTDMANXTDSC2>;
#[doc = "Register HSTDMANXTDSC2 `reset()`'s with value 0"]
impl crate::ResetValue for super::HSTDMANXTDSC2 {
    #[inline(always)]
