#[doc = "Reader of register HSTDMASTATUS6"]
pub type R = crate::R<u32, super::HSTDMASTATUS6>;
#[doc = "Writer for register HSTDMASTATUS6"]
pub type W = crate::W<u32, super::HSTDMASTATUS6>;
#[doc = "Register HSTDMASTATUS6 `reset()`'s with value 0"]
impl crate::ResetValue for super::HSTDMASTATUS6 {
    #[inline(always)]
