#[doc = "Reader of register DEVDMASTATUS2"]
pub type R = crate::R<u32, super::DEVDMASTATUS2>;
#[doc = "Writer for register DEVDMASTATUS2"]
pub type W = crate::W<u32, super::DEVDMASTATUS2>;
#[doc = "Register DEVDMASTATUS2 `reset()`'s with value 0"]
impl crate::ResetValue for super::DEVDMASTATUS2 {
    #[inline(always)]
