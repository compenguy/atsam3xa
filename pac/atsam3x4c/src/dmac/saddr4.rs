#[doc = "Reader of register SADDR4"]
pub type R = crate::R<u32, super::SADDR4>;
#[doc = "Writer for register SADDR4"]
pub type W = crate::W<u32, super::SADDR4>;
#[doc = "Register SADDR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::SADDR4 {
    #[inline(always)]
