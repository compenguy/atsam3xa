#[doc = "Reader of register DADDR2"]
pub type R = crate::R<u32, super::DADDR2>;
#[doc = "Writer for register DADDR2"]
pub type W = crate::W<u32, super::DADDR2>;
#[doc = "Register DADDR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::DADDR2 {
    #[inline(always)]
