#[doc = "Reader of register MID4"]
pub type R = crate::R<u32, super::MID4>;
#[doc = "Writer for register MID4"]
pub type W = crate::W<u32, super::MID4>;
#[doc = "Register MID4 `reset()`'s with value 0"]
impl crate::ResetValue for super::MID4 {
    #[inline(always)]
