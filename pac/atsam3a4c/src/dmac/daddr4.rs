#[doc = "Reader of register DADDR4"]
pub type R = crate::R<u32, super::DADDR4>;
#[doc = "Writer for register DADDR4"]
pub type W = crate::W<u32, super::DADDR4>;
#[doc = "Register DADDR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::DADDR4 {
    #[inline(always)]
