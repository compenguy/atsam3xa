#[doc = "Reader of register CMPM5"]
pub type R = crate::R<u32, super::CMPM5>;
#[doc = "Writer for register CMPM5"]
pub type W = crate::W<u32, super::CMPM5>;
#[doc = "Register CMPM5 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMPM5 {
    #[inline(always)]
