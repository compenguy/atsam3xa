#[doc = "Reader of register CMPV6"]
pub type R = crate::R<u32, super::CMPV6>;
#[doc = "Writer for register CMPV6"]
pub type W = crate::W<u32, super::CMPV6>;
#[doc = "Register CMPV6 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMPV6 {
    #[inline(always)]
