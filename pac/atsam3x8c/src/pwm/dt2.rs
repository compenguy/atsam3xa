#[doc = "Reader of register DT2"]
pub type R = crate::R<u32, super::DT2>;
#[doc = "Writer for register DT2"]
pub type W = crate::W<u32, super::DT2>;
#[doc = "Register DT2 `reset()`'s with value 0"]
impl crate::ResetValue for super::DT2 {
    #[inline(always)]
