#[doc = "Reader of register FPE1"]
pub type R = crate::R<u32, super::FPE1>;
#[doc = "Writer for register FPE1"]
pub type W = crate::W<u32, super::FPE1>;
#[doc = "Register FPE1 `reset()`'s with value 0"]
impl crate::ResetValue for super::FPE1 {
    #[inline(always)]
