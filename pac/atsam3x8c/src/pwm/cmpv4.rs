#[doc = "Reader of register CMPV4"]
pub type R = crate::R<u32, super::CMPV4>;
#[doc = "Writer for register CMPV4"]
pub type W = crate::W<u32, super::CMPV4>;
#[doc = "Register CMPV4 `reset()`'s with value 0"]
impl crate::ResetValue for super::CMPV4 {
    #[inline(always)]
