#[doc = "Reader of register SADDR5"]
pub type R = crate::R<u32, super::SADDR5>;
#[doc = "Writer for register SADDR5"]
pub type W = crate::W<u32, super::SADDR5>;
#[doc = "Register SADDR5 `reset()`'s with value 0"]
impl crate::ResetValue for super::SADDR5 {
    #[inline(always)]
