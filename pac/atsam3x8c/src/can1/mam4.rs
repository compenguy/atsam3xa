#[doc = "Reader of register MAM4"]
pub type R = crate::R<u32, super::MAM4>;
#[doc = "Writer for register MAM4"]
pub type W = crate::W<u32, super::MAM4>;
#[doc = "Register MAM4 `reset()`'s with value 0"]
impl crate::ResetValue for super::MAM4 {
    #[inline(always)]
