#[doc = "Reader of register MMR1"]
pub type R = crate::R<u32, super::MMR1>;
#[doc = "Writer for register MMR1"]
pub type W = crate::W<u32, super::MMR1>;
#[doc = "Register MMR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::MMR1 {
    #[inline(always)]
