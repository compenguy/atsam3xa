#[doc = "Reader of register HSTDMANXTDSC3"]
pub type R = crate::R<u32, super::HSTDMANXTDSC3>;
#[doc = "Writer for register HSTDMANXTDSC3"]
pub type W = crate::W<u32, super::HSTDMANXTDSC3>;
#[doc = "Register HSTDMANXTDSC3 `reset()`'s with value 0"]
impl crate::ResetValue for super::HSTDMANXTDSC3 {
    #[inline(always)]
